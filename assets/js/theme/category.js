...
export default class Category extends CatalogPage {
    ...
    minslider(){
        const priceInputvalue =  document.querySelectorAll("#fromSlider-min");
    ...
    maxslider(){
        const priceInputvalue =  document.querySelectorAll("#fromSlider-max");
        priceInputvalue[0].addEventListener("input", e => { 
            e.preventDefault();
            let maxp = parseInt(priceInputvalue[0].value);
